...
class Order(models.Model):
    ...
    def _get_sale_confirm(self):
        ...
        if template:
            ...
            return "<span style='font-size:10px'><b>Confirmation de la commande :</b><br><br>Veuillez nous retourner toutes les pages de l'offre paraphées ainsi que cette page signée avec la mention<br>\"Bon pour accord\" + le cachet de l'entreprise.</span>"
