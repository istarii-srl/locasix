            ...
            if line.is_insurance():
                ...
                for section_line in section_lines:
                    if not section_line.is_insurance() and section_line.product_id:
                        if is_multi:
                            day_price += section_line.day_price * percentage * section_line.product_uom_qty * (1-section_line.discount/100)
                            week_price += section_line.week_price * percentage * section_line.product_uom_qty * (1-section_line.discount/100)
                            month_price += section_line.month_price * percentage * section_line.product_uom_qty * (1-section_line.discount/100)
                        else:
                            price_unit += section_line.price_unit * percentage * section_line.product_uom_qty * (1-section_line.discount/100)
