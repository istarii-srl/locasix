...
class LocasixSettings(models.TransientModel):
    ...
    email_assembling_handler = fields.Char(string="Email Montage/assemblage", default="o.libbrecht@locasix.be")
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param('locasix.email_assembling_handler', self.email_assembling_handler)
    ...
    def get_values(self):
        ...
        email_assembling_handler = self.env['ir.config_parameter'].sudo().get_param('locasix.email_assembling_handler')
        ...
        res.update({
            ...
            'email_assembling_handler': email_assembling_handler,
        });
        return res